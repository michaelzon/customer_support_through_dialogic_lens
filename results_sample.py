...
pickle_in = open('company_stats_sample.pickle', 'rb')
...
pickle_out_companies_without_outbounds_list = open('companies_without_outbounds_list_sample.pickle', 'wb')
...
pickle_out_companies_with_outbounds_list = open('companies_with_outbounds_list_sample.pickle', 'wb')
...
pickle_out_invalid_companies = open('invalid_companies_sample.pickle', 'wb')
pickle.dump(invalid_companies, pickle_out_invalid_companies)
pickle_out_invalid_companies.close()

# pickle out for invalid_companies dict
pickle_out_valid_companies = open('valid_companies_sample.pickle', 'wb')
